...
public class ScrollSnapRect : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {
    ...
    //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! MY THINGS
    public LevelSelector levelsManager;
    public SkinSelector skinsManager;
    ...
    public void LerpToPage(int aPageIndex) {
        ...
        //Debug.Log(_currentPage);
        //MY ADDS to the code!!!!
        if (UIManager.isLevelShopActive)
            levelsManager.SetLevelInfo(_currentPage);
        else if (UIManager.isSkinShopActive)
            skinsManager.CheckIfBought(_currentPage);
    }
